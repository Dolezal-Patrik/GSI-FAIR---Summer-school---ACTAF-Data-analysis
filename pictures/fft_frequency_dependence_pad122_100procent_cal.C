...
#endif
void fft_frequency_dependence_pad122_100procent_cal()
{
//=========Macro generated from canvas: c_dep/Peak Frequency vs. Peak Index
//=========  (Fri Sep 11 10:27:01 2026) by ROOT version 6.36.04
   TCanvas *c_dep = new TCanvas("c_dep", "Peak Frequency vs. Peak Index", 326, 123, 800, 600);
   gStyle->SetOptFit(0);
   ...
   gre->SetName("Graph");
   gre->SetTitle("Peak Frequency Dependence");
   gre->SetFillStyle(1000);
   gre->SetMarkerColor(TColor::GetColor("#0000cc"));
   gre->SetMarkerStyle(20);
   gre->SetMarkerSize(1.3);
   
   TH1F *Graph_histogram1 = new TH1F("Graph_histogram1", "Peak Frequency Dependence", 100, 0.7, 4.3);
   ...
   Graph_histogram1->GetXaxis()->SetTitle("Peak Index [#]");
   ...
   Graph_histogram1->GetYaxis()->SetTitle("Frequency [kHz]");
   ...
   TPaveText *pt = new TPaveText(0.237494, 0.934373, 0.762506, 0.995, "blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_text5 = pt->AddText("Peak Frequency Dependence");
   pt->Draw("blNDC");
   c_dep->Modified();
